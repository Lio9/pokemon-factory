...
public interface BattleMapper {
    @Insert("INSERT INTO battle(player_id, opponent_team_id, rounds, player_move_map, started_at) VALUES(#{playerId}, #{opponentTeamId}, #{rounds}, #{playerMoveMapJson}, datetime('now'))")
    void insertInitial(@Param("playerId") Integer playerId, @Param("opponentTeamId") Integer opponentTeamId, @Param("rounds") Integer rounds, @Param("playerMoveMapJson") String playerMoveMapJson);
    ...
    @Select("SELECT b.id, b.player_id, b.opponent_team_id, b.started_at, b.ended_at, b.summary_json, t.team_json AS opponent_team_json FROM battle b LEFT JOIN team t ON b.opponent_team_id = t.id WHERE b.id = #{id}")
