<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="flex gap-2 mb-3">
          <div class="h-5 bg-slate-200 rounded-full w-14" /><div class="h-5 bg-slate-100 rounded-full w-14" />
        </div>
        ...
        >
          ...
          <div class="relative z-10">
            <div class="flex items-start justify-between mb-2">
              ...
              >
                <component
                  :is="favorites.has(move.id) ? 'StarFilled' : 'Star'"
                  class="w-4 h-4"
                />
              </button>
            </div>
    ...
    >
      ...
      <div
        v-else-if="!hasMore && moves.length > 0"
    ...
    >
      ...
      >
        <div class="flex items-center gap-3">
          <span
            v-if="selectedMove.typeName"
            class="type-badge"
            :style="{ backgroundColor: selectedMove.typeColor || '#888' }"
